                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: '280px' }}>
                        ...
                        <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: 1.6 }}>
                            CHALOO is provided by <span style={{ color: 'white', fontWeight: '700' }}>digitalraiz creative solutions</span>. For sensitive data inquiries or security audit requests, contact our specialized protocol team at <a href="mailto:umayur2323@gmail.com" style={{ color: 'var(--chalo-blue)', fontWeight: '800', textDecoration: 'none' }}>umayur2323@gmail.com</a>.
                        </p>
                    </div>
                </div>
